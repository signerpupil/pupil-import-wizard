...
// BISTA-Sprachliste (offizielle Codeliste, 89 Werte)
export const BISTA_LANGUAGE_CODES: Record<string, string> = {
  'Schweizerdeutsch': '1101',
  'Deutsch': '110',
  'Französisch': '120',
  'Italienisch': '130',
  'Rätoromanisch': '140',
  ...
  'Tagalog': '433',
  'Tibetisch': '433',
  'Andere europäische Sprachen': '360',
  'Andere afrikanische Sprachen': '410',
  'Andere westasiatische Sprachen': '431',
  'Andere indoarische und drawidische Sprachen': '432',
  'Andere ostasiatische Sprachen': '433',
  'Andere Sprachen (Pidginsprachen, Kreolsprachen, Gebärdensprachen …)': '440',
  'Nicht angegeben (Nur für Tertiär)': '999',
  'Saho': '4101',
  'Kurdisch': '4311',
  'Persisch': '4312',
  'Dari': '4313',
...
export const VALID_BISTA_LANGUAGES = new Set(Object.keys(BISTA_LANGUAGE_CODES));
...
export const LANGUAGE_AUTO_CORRECTIONS: Record<string, string> = {
  ...
  'Züridütsch': 'Schweizerdeutsch',
  'Berndeutsch': 'Schweizerdeutsch',
  'Baseldeutsch': 'Schweizerdeutsch',
  'Bündnerdeutsch': 'Schweizerdeutsch',
  'Walliserdeutsch': 'Schweizerdeutsch',
  ...
  'Tagalog': 'Tagalog',
  'Malayalam': 'Malayalam',
  'Indische Sprachen': 'Andere indoarische und drawidische Sprachen',
  'Paschto': 'Paschto',
  'Urdu': 'Urdu',
  'Swahili': 'Suaheli',
  'Amharisch': 'Amharisch',
  ...
  'Uigurisch': 'Andere ostasiatische Sprachen',
  'Litauisch': 'Litauisch',
  'Paschtou': 'Paschto',
  'Persisch': 'Persisch',
  ...
  'Susu': 'Andere afrikanische Sprachen',
  'Indonesisch': 'Indonesisch',
  'Flämisch': 'Niederländisch',
  'Singalesisch': 'Singhalesisch',
  'Singhalesisch': 'Singhalesisch',
  'Tigrigna': 'Tigrinya',
  'Brasilianisch': 'Portugiesisch',
  'Usbekisch': 'Andere westasiatische Sprachen',
  'Uzbekisch': 'Andere westasiatische Sprachen',
  'Tunesisch': 'Arabisch',
  'Hebräisch': 'Hebräisch',
  // Telemetrie-basierte Ergänzungen (häufig manuell korrigiert)
  'Arabische Sprachen': 'Arabisch',
  'Andere Sprachen': 'Andere Sprachen (Pidginsprachen, Kreolsprachen, Gebärdensprachen …)',
  // Phase 2 additions
  'Somalisch': 'Somali',
  'Eritreisch': 'Tigrinya',
  'Tamilisch': 'Tamilisch',
  ...
  'Georgisch': 'Andere westasiatische Sprachen',
  'Berberisch': 'Andere afrikanische Sprachen',
  'Panjabi': 'Pandschabi',
  'Punjabi': 'Pandschabi',
  'Oromo': 'Andere afrikanische Sprachen',
  'Haussa': 'Andere afrikanische Sprachen',
  'Hausa': 'Andere afrikanische Sprachen',
  'Wolof': 'Andere afrikanische Sprachen',
  'Yoruba': 'Andere afrikanische Sprachen',
  'Igbo': 'Andere afrikanische Sprachen',
  'Birmanisch': 'Andere ostasiatische Sprachen',
  'Burmesisch': 'Andere ostasiatische Sprachen',
  'Khmer': 'Khmer',
  'Lettisch': 'Lettisch',
  'Estnisch': 'Estnisch',
  'Isländisch': 'Isländisch',
  // Phase 3: Fehlende Sprachen (CH-Schulen)
  'Romani': 'Romani',   // Indoarische Sprache (verwandt mit Hindi/Sanskrit)
  'Romanes': 'Romani', // Alternativbezeichnung für Romani
  'Telugu': 'Andere indoarische und drawidische Sprachen',
  'Kannada': 'Andere indoarische und drawidische Sprachen',
  'Gujarati': 'Andere indoarische und drawidische Sprachen',
  'Marathi': 'Andere indoarische und drawidische Sprachen',
  'Kinyarwanda': 'Andere afrikanische Sprachen',
  'Kirundi': 'Andere afrikanische Sprachen',
  'Lingala': 'Lingala',
  'Bambara': 'Andere afrikanische Sprachen',
  'Fulfulde': 'Andere afrikanische Sprachen',
  'Fula': 'Andere afrikanische Sprachen',
  'Twi': 'Andere afrikanische Sprachen',
  'Akan': 'Andere afrikanische Sprachen',
  'Somali': 'Somali',
  'Lao': 'Laotisch',
  'Malaiisch': 'Andere ostasiatische Sprachen',
  'Malay': 'Andere ostasiatische Sprachen',
  'Katalanisch': 'Katalanisch',
  'Baskisch': 'Baskisch',
  'Irisch': 'Andere europäische Sprachen',
  'Gälisch': 'Andere europäische Sprachen',
  ...
  'Zulu': 'Andere afrikanische Sprachen',
  'Xhosa': 'Andere afrikanische Sprachen',
  'Shona': 'Andere afrikanische Sprachen',
  'Ndebele': 'Andere afrikanische Sprachen',
  'Sotho': 'Andere afrikanische Sprachen',
  'Tswana': 'Andere afrikanische Sprachen',
  'Malagasy': 'Andere afrikanische Sprachen',
  'Ewe': 'Andere afrikanische Sprachen',
  'Fon': 'Andere afrikanische Sprachen',
  'Mooré': 'Andere afrikanische Sprachen',
  'Mossi': 'Andere afrikanische Sprachen',
  'Mandinka': 'Andere afrikanische Sprachen',
  'Sango': 'Andere afrikanische Sprachen',
  'Luba': 'Andere afrikanische Sprachen',
  'Chichewa': 'Andere afrikanische Sprachen',
  'Luganda': 'Andere afrikanische Sprachen',
  'Ganda': 'Andere afrikanische Sprachen',
  'Acholi': 'Andere afrikanische Sprachen',
  'Dinka': 'Andere afrikanische Sprachen',
  'Nuer': 'Andere afrikanische Sprachen',
  'Afar': 'Andere afrikanische Sprachen',
  'Beja': 'Andere afrikanische Sprachen',
  'Serer': 'Andere afrikanische Sprachen',
  'Diola': 'Andere afrikanische Sprachen',
  'Jola': 'Andere afrikanische Sprachen',
  'Mende': 'Andere afrikanische Sprachen',
  'Krio': 'Andere afrikanische Sprachen',
  'Edo': 'Andere afrikanische Sprachen',
  'Kikuyu': 'Andere afrikanische Sprachen',
  'Luo': 'Andere afrikanische Sprachen',
  'Runyankole': 'Andere afrikanische Sprachen',
  'Teso': 'Andere afrikanische Sprachen',
  'Nyanja': 'Andere afrikanische Sprachen',
  'Chewa': 'Andere afrikanische Sprachen',
  'Bemba': 'Andere afrikanische Sprachen',
  'Zarma': 'Andere afrikanische Sprachen',
  'Kanuri': 'Andere afrikanische Sprachen',
  'Tiv': 'Andere afrikanische Sprachen',
  'Efik': 'Andere afrikanische Sprachen',
  'Nupe': 'Andere afrikanische Sprachen',
  'Bamileke': 'Andere afrikanische Sprachen',
  'Duala': 'Andere afrikanische Sprachen',
  'Fang': 'Andere afrikanische Sprachen',
  'Ewondo': 'Andere afrikanische Sprachen',
  'Soga': 'Andere afrikanische Sprachen',
  'Maninka': 'Andere afrikanische Sprachen',
  'Soninke': 'Andere afrikanische Sprachen',
  'Temne': 'Andere afrikanische Sprachen',
  'Kpelle': 'Andere afrikanische Sprachen',
  'Dioula': 'Andere afrikanische Sprachen',
  'Senufo': 'Andere afrikanische Sprachen',
  'Peul': 'Andere afrikanische Sprachen',
  'Malinke': 'Andere afrikanische Sprachen',
  'Suaheli': 'Suaheli',
  'Kiswahili': 'Andere afrikanische Sprachen',
  'Setswana': 'Andere afrikanische Sprachen',
  'Sesotho': 'Andere afrikanische Sprachen',
  'Sepedi': 'Andere afrikanische Sprachen',
  'Siswati': 'Andere afrikanische Sprachen',
  'Tsonga': 'Andere afrikanische Sprachen',
  'Venda': 'Andere afrikanische Sprachen',
  'Tshiluba': 'Andere afrikanische Sprachen',
  'Lingála': 'Andere afrikanische Sprachen',
  'Kikongo': 'Andere afrikanische Sprachen',
  'Makonde': 'Andere afrikanische Sprachen',
  'Sukuma': 'Andere afrikanische Sprachen',
  ...
  'Sindhi': 'Andere indoarische und drawidische Sprachen',
  'Odia': 'Andere indoarische und drawidische Sprachen',
  'Oriya': 'Andere indoarische und drawidische Sprachen',
  'Assamesisch': 'Andere indoarische und drawidische Sprachen',
  'Konkani': 'Andere indoarische und drawidische Sprachen',
  'Maithili': 'Andere indoarische und drawidische Sprachen',
  'Bhojpuri': 'Andere indoarische und drawidische Sprachen',
  'Rajasthani': 'Andere indoarische und drawidische Sprachen',
  'Chhattisgarhi': 'Andere indoarische und drawidische Sprachen',
  'Dogri': 'Andere indoarische und drawidische Sprachen',
  'Kashmiri': 'Andere indoarische und drawidische Sprachen',
  'Santali': 'Andere indoarische und drawidische Sprachen',
  'Tulu': 'Andere indoarische und drawidische Sprachen',
  'Saraiki': 'Andere indoarische und drawidische Sprachen',
  'Balti': 'Andere indoarische und drawidische Sprachen',
  'Nepali': 'Nepali',
  'Sinhala': 'Andere ostasiatische Sprachen',
  'Dhivehi': 'Andere indoarische und drawidische Sprachen',
  'Maldivisch': 'Andere indoarische und drawidische Sprachen',

  // --- Ostasiatische Sprachen (erweitert) ---
  'Hmong': 'Andere ostasiatische Sprachen',
  'Miao': 'Andere ostasiatische Sprachen',
  'Zhuang': 'Andere ostasiatische Sprachen',
  'Yi': 'Andere ostasiatische Sprachen',
  'Mien': 'Andere ostasiatische Sprachen',
  'Yao': 'Andere ostasiatische Sprachen',
  'Dong': 'Andere ostasiatische Sprachen',
  // 'Mongolisch' und 'Tibetisch' entfernt — sind bereits gültige BISTA-Werte

  // --- Übrige süd- und südostasiatische Sprachen (erweitert) ---
  'Javanisch': 'Andere ostasiatische Sprachen',
  'Sundanesisch': 'Andere ostasiatische Sprachen',
  'Cebuano': 'Andere ostasiatische Sprachen',
  'Ilocano': 'Andere ostasiatische Sprachen',
  'Bisaya': 'Andere ostasiatische Sprachen',
  'Visaya': 'Andere ostasiatische Sprachen',
  'Shan': 'Andere ostasiatische Sprachen',
  'Karen': 'Andere ostasiatische Sprachen',
  'Mon': 'Andere ostasiatische Sprachen',
  'Cham': 'Andere ostasiatische Sprachen',
  'Tetum': 'Andere ostasiatische Sprachen',
  'Balinesisch': 'Andere ostasiatische Sprachen',
  'Minangkabau': 'Andere ostasiatische Sprachen',
  'Acehnese': 'Andere ostasiatische Sprachen',
  'Waray': 'Andere ostasiatische Sprachen',
  'Pangasinan': 'Andere ostasiatische Sprachen',
  'Hiligaynon': 'Andere ostasiatische Sprachen',
  'Bikol': 'Andere ostasiatische Sprachen',
  'Malaysisch': 'Andere ostasiatische Sprachen',
  'Dzongkha': 'Andere ostasiatische Sprachen',
  'Bhutanisch': 'Andere ostasiatische Sprachen',

  // --- Westasiatische Sprachen (erweitert) ---
  'Aserbaidschanisch': 'Andere westasiatische Sprachen',
  'Tadschikisch': 'Andere westasiatische Sprachen',
  'Turkmenisch': 'Andere westasiatische Sprachen',
  'Belutschi': 'Andere westasiatische Sprachen',
  'Balochi': 'Andere westasiatische Sprachen',
  'Hazaragi': 'Andere westasiatische Sprachen',
  'Paschtunisch': 'Andere westasiatische Sprachen',
  'Zaza': 'Andere westasiatische Sprachen',
  'Zazaki': 'Andere westasiatische Sprachen',
  'Gilaki': 'Andere westasiatische Sprachen',
  'Mazandarani': 'Andere westasiatische Sprachen',
  'Luri': 'Andere westasiatische Sprachen',

  // --- Übrige westasiatische Sprachen (erweitert) ---
  'Kirgisisch': 'Andere westasiatische Sprachen',
  'Kasachisch': 'Andere westasiatische Sprachen',
  'Tschetschenisch': 'Andere westasiatische Sprachen',
  'Awarisch': 'Andere westasiatische Sprachen',
  'Ossetisch': 'Andere westasiatische Sprachen',
  'Abchasisch': 'Andere westasiatische Sprachen',
  'Tscherkessisch': 'Andere westasiatische Sprachen',
  'Kabardinisch': 'Andere westasiatische Sprachen',
  'Inguschisch': 'Andere westasiatische Sprachen',
  'Dagestanisch': 'Andere westasiatische Sprachen',
  'Tatarisch': 'Andere westasiatische Sprachen',
  'Baschkirisch': 'Andere westasiatische Sprachen',
  'Tschuwaschisch': 'Andere westasiatische Sprachen',
  'Jakutisch': 'Andere westasiatische Sprachen',

  // --- Andere westeuropäische Sprachen (erweitert) ---
  'Walisisch': 'Walisisch',
  'Bretonisch': 'Bretonisch',
  'Okzitanisch': 'Andere europäische Sprachen',
  'Galicisch': 'Galizisch',
  'Korsisch': 'Korsisch',
  'Sardisch': 'Sardisch',
  'Maltesisch': 'Andere europäische Sprachen',
  'Luxemburgisch': 'Andere europäische Sprachen',
  'Friesisch': 'Friesisch',
  'Asturisch': 'Andere europäische Sprachen',
  'Aragonesisch': 'Andere europäische Sprachen',
  'Ladinisch': 'Andere europäische Sprachen',
  'Furlanisch': 'Andere europäische Sprachen',

  // --- Andere nordeuropäische Sprachen (erweitert) ---
  'Samisch': 'Andere europäische Sprachen',
  'Sami': 'Andere europäische Sprachen',
  'Färöisch': 'Andere europäische Sprachen',
  'Faröisch': 'Andere europäische Sprachen',
  'Grönländisch': 'Andere europäische Sprachen',

  // --- Übrige osteuropäische Sprachen (erweitert) ---
  'Weissrussisch': 'Andere europäische Sprachen',
  'Belarussisch': 'Andere europäische Sprachen',
  'Moldawisch': 'Rumänisch', // Moldawisch ist linguistisch identisch mit Rumänisch

  // --- Übrige slawische Sprachen ---
  'Sorbisch': 'Sorbisch',
  'Ruthenisch': 'Andere europäische Sprachen',
  'Kaschubisch': 'Andere europäische Sprachen',
  'Russinisch': 'Andere europäische Sprachen',
  ...
  'Quechua': 'Andere Sprachen (Pidginsprachen, Kreolsprachen, Gebärdensprachen …)',
  'Aymara': 'Andere Sprachen (Pidginsprachen, Kreolsprachen, Gebärdensprachen …)',
  'Guaraní': 'Andere Sprachen (Pidginsprachen, Kreolsprachen, Gebärdensprachen …)',
  'Guarani': 'Andere Sprachen (Pidginsprachen, Kreolsprachen, Gebärdensprachen …)',
  'Nahuatl': 'Andere Sprachen (Pidginsprachen, Kreolsprachen, Gebärdensprachen …)',
  'Maya': 'Andere Sprachen (Pidginsprachen, Kreolsprachen, Gebärdensprachen …)',
  'Kreolisch': 'Andere Sprachen (Pidginsprachen, Kreolsprachen, Gebärdensprachen …)',
  'Pidgin': 'Andere Sprachen (Pidginsprachen, Kreolsprachen, Gebärdensprachen …)',
  'Gebärdensprache': 'Andere Sprachen (Pidginsprachen, Kreolsprachen, Gebärdensprachen …)',
  'Zeichensprache': 'Andere Sprachen (Pidginsprachen, Kreolsprachen, Gebärdensprachen …)',
  ...
  'Rusisch': 'Russisch',
  'Polnish': 'Polnisch',
  'Tschetschenish': 'Andere westasiatische Sprachen',
  'Rumänish': 'Rumänisch',
...
function checkSameIdDifferentPerson(rows: ParsedRow[], field: string, rowNumbers: number[]): boolean {
  ...
  const refRow = rows[rowNumbers[0] - 2];
