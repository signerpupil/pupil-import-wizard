...
export default function Index() {
  ...
  const showSummary = currentStep >= 1 && importType !== 'gruppen' && importType !== 'lp-zuweisung' && importType !== 'stammdaten-lehrpersonen';
  ...
  const showSpecialWizard = showGroupWizard || showLPWizard || showStammdatenLPWizard;

  return (
    <div className="min-h-screen bg-background flex flex-col">
      <WizardHeader title={getStepTitle()} showStep={currentStep >= 1} />
