...
describe('Shared Formatters', () => {
  ...
  describe('formatStreet', () => {
    ...
    it('expands str. abbreviation', () => {
      expect(formatStreet('bahnhofstr. 5')).toBe('Bahnhofstrasse 5');
    });
    it('expands pl. abbreviation', () => {
      expect(formatStreet('dorfpl. 3')).toBe('Dorfplatz 3');
    });
