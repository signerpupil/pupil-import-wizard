...
const baseCols: ColumnDefinition[] = [
  { name: 'S_ID', required: true, validationType: 'text', category: 'student', sort_order: 0 },
  { name: 'S_AHV', required: false, validationType: 'ahv', category: 'student', sort_order: 1 },
  { name: 'S_Name', required: true, validationType: 'text', category: 'student', sort_order: 2 },
  { name: 'S_Vorname', required: true, validationType: 'text', category: 'student', sort_order: 3 },
  { name: 'S_Geschlecht', required: false, validationType: 'gender', category: 'student', sort_order: 4 },
  { name: 'S_Geburtsdatum', required: false, validationType: 'date', category: 'student', sort_order: 5 },
  { name: 'S_PLZ', required: false, validationType: 'plz', category: 'student', sort_order: 6 },
  { name: 'S_Ort', required: false, validationType: 'text', category: 'student', sort_order: 7 },
  { name: 'S_Muttersprache', required: false, validationType: 'language', category: 'student', sort_order: 8 },
  { name: 'S_Nationalitaet', required: false, validationType: 'nationality', category: 'student', sort_order: 9 },
  { name: 'P_ERZ1_ID', required: false, validationType: 'text', category: 'parent', sort_order: 10 },
  { name: 'P_ERZ1_AHV', required: false, validationType: 'ahv', category: 'parent', sort_order: 11 },
  { name: 'P_ERZ1_Name', required: false, validationType: 'text', category: 'parent', sort_order: 12 },
  { name: 'P_ERZ1_Vorname', required: false, validationType: 'text', category: 'parent', sort_order: 13 },
  { name: 'P_ERZ2_ID', required: false, validationType: 'text', category: 'parent', sort_order: 14 },
  { name: 'P_ERZ2_AHV', required: false, validationType: 'ahv', category: 'parent', sort_order: 15 },
  { name: 'P_ERZ2_Name', required: false, validationType: 'text', category: 'parent', sort_order: 16 },
  { name: 'P_ERZ2_Vorname', required: false, validationType: 'text', category: 'parent', sort_order: 17 },
];
